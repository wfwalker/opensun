var shotclockDraw = {
    ...
    privateDrawShadow: function() {
        ...
        // rotate the collection of objects associated with the sun angle
        $('#sunangle')[0].transform.baseVal.getItem(0).setRotate(this.currentSunPosition.azimuth, 125, 125);
